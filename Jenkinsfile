...
def xcodeproj = 'Pokemon.xcodeproj' // Path to the xcodeproj
def xcarchive_name = "Pokemon.xcarchive" // Name of the archive to build
def build_scheme = 'Pokemon' // Scheme to build the app
def test_scheme = 'PokemonTests' // Scheme to build tests
def simulator_device = 'iPhone 8' // Name of the device type to use for tests
