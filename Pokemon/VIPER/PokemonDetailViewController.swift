...
//        self.dismiss(animated: true)
        detailPresenter.closeViewDetail(view: self)
    }
    ...
    var detailPresenter: ViewToPresenterDetailPokemonType!
    
    override func viewDidLoad() {
        super.viewDidLoad()
        septupUI()
        PokemonDetailRouter.createDetailPokemonView(detailReference: self)
        detailPresenter.fetchPokemon(idPokemon: pokemon!.id!)
    }
...
extension PokemonDetailViewController: PresenterToViewDetailPokemonResponsable{
    func onDetailPokemonResponseSucess(datail: String) {
        self.pokemonDescriptionText.text = datail
    }
