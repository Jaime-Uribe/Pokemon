...
#ifndef NOTIFICATIONBANNERSWIFT_SWIFT_H
#define NOTIFICATIONBANNERSWIFT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NotificationBannerSwift",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP23NotificationBannerSwift20BannerColorsProtocol_")
@protocol BannerColorsProtocol
- (UIColor * _Nonnull)colorFor:(enum BannerStyle)style SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC23NotificationBannerSwift21BannerHapticGenerator")
...
SWIFT_CLASS("_TtC23NotificationBannerSwift22BaseNotificationBanner")
...
SWIFT_CLASS("_TtC23NotificationBannerSwift25GrowingNotificationBanner")
...
SWIFT_CLASS("_TtC23NotificationBannerSwift26FloatingNotificationBanner")
...
SWIFT_CLASS("_TtC23NotificationBannerSwift18NotificationBanner")
...
SWIFT_CLASS("_TtC23NotificationBannerSwift23NotificationBannerQueue")
...
SWIFT_CLASS("_TtC23NotificationBannerSwift27StatusBarNotificationBanner")
